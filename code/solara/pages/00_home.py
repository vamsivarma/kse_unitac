...
def Page():
    with solara.Column(align="center"):
        ...
        **A collection of [Solara](https://github.com/widgetti/solara) web apps for geospatial applications.**
        ...
        Just a proof-of-concept for now, updated. Not all features are working yet. More features will be added in the future. Click on the menu above to see the other pages.
